...
class SourceFieldTest extends AbstractEntityTestWithUpdate
{
    ...
    public function createDataProvider(): iterable
    {
        ...
        return [
            ...
            [$adminUser, ['code' => 'description', 'metadata' => $this->getUri('metadata', '4')], 201],
            [$adminUser, ['code' => 'weight', 'metadata' => $this->getUri('metadata', '4')], 201],
            [$adminUser, ['code' => 'image', 'metadata' => $this->getUri('metadata', '5')], 201],
            [$adminUser, ['code' => 'length', 'isSearchable' => true, 'metadata' => $this->getUri('metadata', '4'), 'weight' => 2], 201],
            [$adminUser, ['code' => 'height', 'isUsedInAutocomplete' => true, 'metadata' => $this->getUri('metadata', '4')], 201],
            [$adminUser, ['code' => 'width', 'isFilterable' => false, 'isUsedInAutocomplete' => true, 'metadata' => $this->getUri('metadata', '4')], 201],
            [$adminUser, ['code' => 'description'], 422, 'metadata: This value should not be blank.'],
            [$adminUser, ['metadata' => $this->getUri('metadata', '4')], 422, 'code: This value should not be blank.'],
            [
                $adminUser,
                ['code' => 'long_description', 'metadata' => $this->getUri('metadata', '4'), 'type' => 'description'],
                422,
            ...
            [
                $adminUser,
                ['code' => 'name', 'metadata' => $this->getUri('metadata', '4')],
                422,
                'code: A field with this code already exist for this entity.',
            ],
            [
                $adminUser,
                ['code' => 'color', 'isSearchable' => true, 'metadata' => $this->getUri('metadata', '4'), 'weight' => 0],
                422,
                'weight: The value you selected is not a valid choice.',
            ],
            [
                $adminUser,
                ['code' => 'color', 'isSearchable' => true, 'metadata' => $this->getUri('metadata', '4'), 'weight' => 11],
                422,
                'weight: The value you selected is not a valid choice.',
            ],
            [$adminUser, ['code' => 'my_category', 'metadata' => $this->getUri('metadata', '4'), 'type' => 'category'], 201],
            [
                $adminUser,
                ['code' => 'my_category.id', 'metadata' => $this->getUri('metadata', '4'), 'type' => 'keyword'],
                500,
                "You can't create a source field with the code 'my_category.id' because a source field with the code 'my_category' exists.",
            ],
            [$adminUser, ['code' => 'my_price.price', 'metadata' => $this->getUri('metadata', '4'), 'type' => 'float'], 201],
            [
                $adminUser,
