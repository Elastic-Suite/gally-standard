...
use Gally\Job\Tests\Api\GraphQl\Job\Source\StatusOptionTest as GraphQlStatusOptionTest;
use Gally\Test\ExpectedResponse;
use Gally\Test\RequestToTest;
use Gally\User\Entity\User;
use Symfony\Contracts\HttpClient\ResponseInterface;

class StatusOptionTest extends GraphQlStatusOptionTest
{
    /**
    ...
    public function testGetCollection(?User $user, array $expectedData, int $responseCode): void
    {
        $this->validateApiCall(
            new RequestToTest('GET', 'job_status_options', $user),
