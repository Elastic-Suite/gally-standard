...
/**
 * Default implementation for ES mapping field (Smile\GallyCore\Api\Index\Mapping\FieldInterface).
 */
class Field implements FieldInterface
{
    ...
    private function getMultiFieldMappingPropertyConfig(array $analyzers): array
    {
        ...
        // Prevent to propagate specific configuration to sub fields.
        unset($this->config[self::SPECIFIC_CONFIGURATION_KEY]);
