...
use Gally\Configuration\Tests\Api\GraphQl\Source\LocalizedCatalogGroupOptionTest as GraphQlLocalizedCatalogGroupOptionTest;
...
class LocalizedCatalogGroupOptionTest extends GraphQlLocalizedCatalogGroupOptionTest
{
    ...
    public function testGetCollection(array $expectedData): void
    {
        $this->validateApiCall(
            new RequestToTest('GET', 'configuration_localized_catalog_group_options', $this->getUser(Role::ROLE_CONTRIBUTOR)),
