...
use Gally\Configuration\Tests\Api\GraphQl\Source\LanguageOptionTest as GraphQlLanguageOptionTest;
...
class LanguageOptionTest extends GraphQlLanguageOptionTest
{
    ...
    public function testGetCollection(array $expectedData): void
    {
        $this->validateApiCall(
            new RequestToTest('GET', 'configuration_language_options', $this->getUser(Role::ROLE_CONTRIBUTOR)),
