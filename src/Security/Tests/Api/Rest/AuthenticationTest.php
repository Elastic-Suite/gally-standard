...
class AuthenticationTest extends AbstractTestCase
{
    ...
    public function testLoginRest(): void
    {
        ...
        // Test before login
        $client->request('GET', $this->getApiRoutePrefix() . 'catalogs');
        $this->assertResponseStatusCodeSame(200);
        $client->request('POST', $this->getApiRoutePrefix() . 'catalogs', ['json' => $catalog]);
        ...
        $client->request('GET', $this->getApiRoutePrefix() . 'catalogs');
        $this->assertResponseStatusCodeSame(200);
        $client->request('POST', $this->getApiRoutePrefix() . 'catalogs', ['auth_bearer' => $token, 'json' => $catalog]);
