...
class DateAggregationConfigResolver implements FieldAggregationConfigResolverInterface
{
    ...
    public function getConfig(ContainerConfigurationInterface $containerConfig, SourceField $sourceField): array
    {
        return [
            ...
            'minDocCount' => 1,
            'interval' => $this->configurationRepository->getScopedConfigValue('gally.search_settings.aggregations.default_date_range_interval'),
            'format' => $this->configurationRepository->getScopedConfigValue('gally.search_settings.default_date_field_format'),
        ];
    }
}
