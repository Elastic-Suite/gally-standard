...
class AutocompleteSourceFields implements AggregationProviderInterface
{
    ...
    private function getAggregationConfig(SourceField $sourceField, ContainerConfigurationInterface $containerConfig): array
    {
        ...
        $config['size'] = $this->configurationRepository->getScopedConfigValue("gally.autocomplete_settings.{$entity}_attribute.max_size")
            ?? $this->configurationRepository->getScopedConfigValue('gally.autocomplete_settings.document_attribute.max_size');
