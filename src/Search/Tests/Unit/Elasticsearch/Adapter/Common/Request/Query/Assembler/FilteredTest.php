...
use Gally\Search\Elasticsearch\Adapter\Common\Request\Query\Assembler\Filtered as FilteredQueryAssembler;
use Gally\Search\Elasticsearch\Request\Query\Filtered as FilteredQuery;
