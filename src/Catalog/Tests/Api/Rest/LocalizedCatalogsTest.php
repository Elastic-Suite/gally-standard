...
class LocalizedCatalogsTest extends AbstractEntityTestWithUpdate
{
    ...
    public function createDataProvider(): iterable
    {
        ...
        return [
            ...
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'empty_name', 'name' => '', 'locale' => 'en_US', 'currency' => 'USD'], 422, 'name: This value should not be blank.'],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'missing_name', 'locale' => 'fr_FR', 'currency' => 'EUR'], 422, 'name: This value should not be blank.'],
            [$this->getUser(Role::ROLE_CONTRIBUTOR), ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'valid_code', 'name' => 'Unauthorized user', 'locale' => 'fr_FR', 'currency' => 'EUR'], 403],
            ...
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'missing_locale', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value should not be blank."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'fr-fr', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value is not valid."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'strin', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value is not valid.\nlocale: This value is not a valid locale."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'too_long_locale', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value is not valid.\nlocale: This value should have exactly 5 characters.\nlocale: This value is not a valid locale."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'a', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value is not valid.\nlocale: This value should have exactly 5 characters.\nlocale: This value is not a valid locale."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'abc', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value is not valid.\nlocale: This value should have exactly 5 characters.\nlocale: This value is not a valid locale."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'ep_EP', 'currency' => 'EUR'], 422, "name: This value should not be blank.\nlocale: This value is not a valid locale."],
            [$adminUser, ['catalog' => $this->getUri('catalogs', '1'), 'code' => 'cat_1_invalid', 'locale' => 'fr_FR', 'currency' => 'ZZZ'], 422, "name: This value should not be blank.\ncurrency: This value is not a valid currency."],
        ];
    }
