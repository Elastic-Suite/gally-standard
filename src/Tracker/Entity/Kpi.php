...
#[ApiFilter(filterClass: SearchFilter::class, properties: ['localizedCatalog' => 'exact', 'startDate' => 'exact', 'endDate' => 'exact'])]
class Kpi
{
    ...
    public function setPageViewCount(int $pageViewCount): self
    {
