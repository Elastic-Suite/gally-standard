...
class UserManager
{
    ...
    public function create(string $firstName, string $lastName, string $email, array $roles, string $password, bool $isActive = true): void
    {
        $user = new User();
    ...
    public function update(string $currentEmail, ?string $firstName, ?string $lastName, ?string $email, ?array $roles, ?string $password, ?bool $isActive = null): void
    {
        /** @var User|null $user */
        ...
        $user->setIsActive($isActive ?? $user->getIsActive());
