...
#[AsCommand(name: 'gally:user:update')]
class UpdateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->cmdValidator->isBoolean($question, true);
        $isActive = $helper->ask($input, $output, $question);

        $this->userManager->update($currentEmail, $firstName, $lastName, $email, $roles, $password, $isActive);
